...
<div align="right">
<a href="adm_modelo.form.php?action=adicionar" class="btn btn-primary" >
Adicionar modelo
</a>
</div>
<!-- inicio de las opciones-->
...
<a href="adm_modelo.form.php?id=<?PHp echo $a_resp2['id']?>&action=edit">
<img title="Click para editar" src="../images/ico/edit.png" width="22" height="22">
</a>
</td>
<td><?PHp echo $a_resp[$i]['id_modelo'];?></td>
<td><?PHp echo $a_resp[$i]['nombre_modelo'];?></td>
