<?php
/*
V1.71 18 Jan 2001 (c) 2000, 2001 John Lim. All rights reserved.
  ...
  Portable version of oci8, to make it more similar to other databases.
...
include_once(ADODB_DIR.'/adodb-oci8.inc.php');

class ADODB_oci8po extends ADODB_oci8 {
    var $databaseType = 'oci8po';
	var $dataProvider = 'oci8po';
